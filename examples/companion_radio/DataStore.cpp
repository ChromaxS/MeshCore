...
void DataStore::loadPrefsInt(const char *filename, NodePrefs& _prefs, double& node_lat, double& node_lon) {
  ...
  if (file) {
    ...
    // file.read((uint8_t *)&_prefs.sx126x_rx_boosted_gain, sizeof(_prefs.sx126x_rx_boosted_gain)); // 88 BUG
...
void DataStore::savePrefs(const NodePrefs& _prefs, double node_lat, double node_lon) {
  ...
  if (file) {
    ...
    // file.write((uint8_t *)&_prefs.sx126x_rx_boosted_gain, sizeof(_prefs.sx126x_rx_boosted_gain)); // 88 BUG
